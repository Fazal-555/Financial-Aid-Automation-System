...
const Installments = () => {
    ...
    return (
        <Box p={{ xs: 3 }} className="page align form-fill">
            <Typography variant='h4' className='title' sx={{ padding: '20px', paddingLeft: '10px' }}>Installments Record<span className='dot'>.</span></Typography>
            <Grid container justifyContent='center' rowSpacing={3} mt={2}>
                <Grid container item columnSpacing={{ sm: 6, xs: 1 }} justifyContent='center' rowSpacing={3}>
                    ...
                    <Grid item xs={10} md={5}>
                        <FormControl fullWidth>
                            <InputLabel id="demo-simple-select-label">Installments</InputLabel>
                            <Select
                                labelId="demo-simple-select-label"
                                id="demo-simple-select"
                                value={installment}
                            ...
                            >
                                <MenuItem disabled value={5}>Select Status</MenuItem>
